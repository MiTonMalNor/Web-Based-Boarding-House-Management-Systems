				...
				<div class="col-md-12">
					<div class="row">
						...
						<div class="col-sm-4">
							<div class="card border-info">
								<div class="card-body bg-light">
									<h4><b>Annual Payments Report</b></h4>
								</div>
								<div class="card-footer">
									<div class="col-md-12">
										<a href="index.php?page=annual_payment_report" class="d-flex justify-content-between"> <span>View Report</span> <span class="fa fa-chevron-circle-right"></span></a>
									</div>
								</div>
							</div>
						</div>
