						...
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-outline-success edit_invoice" type="button" data-id="<?php echo $row['id'] ?>" >Edit</button>
...
<script>
	...
	$('#new_invoice').click(function(){
		uni_modal("Create New Invoice","manage_invoices.php","mid-large")
		
	})
	$('.edit_invoice').click(function(){
		uni_modal("Manage Invoice Details","manage_invoices.php?id="+$(this).attr('data-id'),"mid-large")
