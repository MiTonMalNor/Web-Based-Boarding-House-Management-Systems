                        ...
                        <div class="col-md-3 mb-2">
                            <div class="card border-primary">
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <a href="index.php?page=staff_ptenants_booking" class="text-primary float-right">View List <span class="fa fa-angle-right"></span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 mb-2">
                            <div class="card border-danger">
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <a href="index.php?page=staff_prospective_tenants" class="text-danger float-right">View List <span class="fa fa-angle-right"></span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 mb-2">
                            <div class="card border-warning">
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <a href="index.php?page=staff_room_management" class="text-warning float-right">View List <span class="fa fa-angle-right"></span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 mb-2">
                            <div class="card border-success">
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <a href="index.php?page=staff_bed_management" class="text-success float-right">View Payments <span class="fa fa-angle-right"></span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-3 mb-2">
                            <div class="card border-success">
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <a href="index.php?page=staff_tenantsAndprospect" class="text-success float-right">View List <span class="fa fa-angle-right"></span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 mb-2">
                            <div class="card border-dark">
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <a href="index.php?page=staff_bed_assignment" class="text-dark float-right">View List <span class="fa fa-angle-right"></span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 mb-2">
                            <div class="card border-info">
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <a href="index.php?page=staff_invoices" class="text-info float-right">View List <span class="fa fa-angle-right"></span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 mb-2">
                            <div class="card border-dark">
                                ...
                                <div class="card-footer border-dark">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <a href="index.php?page=staff_payment_report" class="text-dark float-right">View Payments <span class="fa fa-angle-right"></span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
