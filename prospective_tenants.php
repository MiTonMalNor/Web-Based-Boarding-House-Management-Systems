							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										...
										<button class="btn btn-sm btn-outline-danger delete_prospective_tenants" type="button" data-id="<?php echo $row['id'] ?>">Delete</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
...
<script>
	...
	$('#new_tenants_profile').click(function(){
		uni_modal("Add in Tenants Profile","manage_tenants_profile.php","mid-large")
		
	})

	$('.edit_prospective_tenants').click(function(){
		uni_modal("Add in Tenants Profile","manage_prospective_tenants.php?id="+$(this).attr('data-id'),"mid-large")
